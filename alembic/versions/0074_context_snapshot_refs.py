...
Revision ID: 0074_context_snapshot_refs
...
revision = "0074_context_snapshot_refs"
...
def downgrade() -> None:
    op.drop_column("context_snapshots", "protocol_required_refs")
    op.drop_column("context_snapshots", "collapsed_refs")
    op.drop_column("context_snapshots", "included_refs")
