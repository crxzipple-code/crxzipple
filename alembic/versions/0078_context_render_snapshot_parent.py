"""context render snapshot parent

Revision ID: 0078_context_render_snapshot_parent
...
revision = "0078_context_render_snapshot_parent"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_context_render_snapshots_parent_snapshot_id",
        "context_render_snapshots",
        ["parent_snapshot_id"],
    )
...
def downgrade() -> None:
    ...
    op.drop_column("context_render_snapshots", "parent_tree_revision")
    op.drop_column("context_render_snapshots", "parent_snapshot_id")
