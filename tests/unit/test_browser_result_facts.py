...
from tools.browser.local import (
    _browser_result_facts,
    _browser_result_details,
)


def test_browser_result_facts_records_shapes_without_raw_values() -> None:
    content = {
    ...
    evidence = _browser_result_facts(
...
def test_browser_result_facts_records_action_replay_and_script_indices() -> None:
    content = {
        "kind": "action-trace",
        "target_id": "tab-east",
        "action": {
