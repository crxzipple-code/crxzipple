...
stop_matching_processes "operations-observer" "python -m crxzipple.main operations-observer run"
stop_matching_processes "event-relay" "python -m crxzipple.main event-relay run"
