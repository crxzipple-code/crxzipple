...
class SessionApplicationService:
    def __init__(
        ...
        *,
        ...
        self.reader = SessionQueryReader(uow_factory)
    ...
    def get_session(self, session_key: str) -> Session:
        return self.reader.get_session(session_key)

    def list_sessions(self, *, agent_id: str | None = None) -> list[Session]:
        return self.reader.list_sessions(agent_id=agent_id)
    ...
    def list_items(
        ...
        return self.reader.list_items(data)

    def build_replay_window(
        self,
        data: BuildSessionReplayWindowInput,
    ) -> SessionReplayWindow:
        return self.reader.build_replay_window(data)

    def build_maintenance_window(
        self,
        data: BuildSessionMaintenanceWindowInput,
    ) -> SessionReplayWindow:
        return self.reader.build_maintenance_window(data)

    def get_session_with_items(
        self,
        data: ListSessionItemsInput,
    ) -> SessionItemsBundle:
        return self.reader.get_session_with_items(data)
