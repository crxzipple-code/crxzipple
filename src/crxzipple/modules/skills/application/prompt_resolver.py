...
class SkillPromptResolutionContext:
...
class SkillPromptResolution:
    ...
    @property
    def prompt_catalog(self) -> SkillCatalogPrompt | None:
...
class SkillPromptResolver:
    ...
    def resolve(
        ...
        *,
        ...
        context: SkillPromptResolutionContext | None = None,
    ) -> SkillPromptResolution:
        resolved_context = context or SkillPromptResolutionContext()
