...
def bootstrap(
    ...
    return UiBootstrapResponse(
        ...
        routes=[
            ...
            "/access/check",
            "/access/setup",
            "/daemon/services/{service_key}/ensure",
            "/daemon/services/{service_key}/healthcheck",
            "/daemon/services/{service_key}/reconcile",
            "/daemon/services/{service_key}/stop",
            "/skills",
            "/skills/validate",
            "/skills/install",
            "/ui/trace/{trace_id}",
